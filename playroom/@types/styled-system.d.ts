...
declare function get(obj: any, ...paths: Array<string | number>): any;

declare type ObjectOrArray<T> = T[] | { [K: string]: T | ObjectOrArray<T> };

declare type Scale = ObjectOrArray<number | string>;

declare type TLengthStyledSystem = string | 0 | number;

declare type ResponsiveValue<T> = T | Array<T | null> | { [key: string]: T };
...
declare interface LowLevelStyleFunctionArguments<N, S> {
    prop: string;
    cssProperty?: string;
    alias?: string;
    key?: string;
...
declare function style<N = string | number, S = Scale>(
...
declare function compose(...parsers: styleFn[]): styleFn;
declare function system(styleDefinitions: Config): styleFn;
declare function createParser(config: ConfigStyle): styleFn;
declare function createStyleFunction(args: ConfigStyle): styleFn;

declare interface VariantArgs {
    key?: string;
...
declare function variant(props: VariantArgs): (...args: any[]) => any;
 ...
 */
declare interface SpaceProps<TLength = TLengthStyledSystem> {
...
declare interface MarginProps
    extends Pick<
        ...
        | 'mx'
    > {}
declare interface MarginTopProps extends Pick<SpaceProps, 'mt' | 'marginTop'> {}
declare interface MarginBottomProps extends Pick<SpaceProps, 'mb' | 'marginBottom'> {}
declare interface MarginLeftProps extends Pick<SpaceProps, 'ml' | 'marginLeft'> {}
declare interface MarginRightProps extends Pick<SpaceProps, 'mr' | 'marginRight'> {}

declare const margin: styleFn;
declare const marginTop: styleFn;
declare const marginBottom: styleFn;
declare const marginLeft: styleFn;
declare const marginRight: styleFn;
...
declare interface PaddingProps
    extends Pick<
        ...
        | 'px'
    > {}
declare interface PaddingTopProps extends Pick<SpaceProps, 'pt' | 'paddingTop'> {}
declare interface PaddingBottomProps extends Pick<SpaceProps, 'pb' | 'paddingBottom'> {}
declare interface PaddingLeftProps extends Pick<SpaceProps, 'pl' | 'paddingLeft'> {}
declare interface PaddingRightProps extends Pick<SpaceProps, 'pr' | 'paddingRight'> {}

declare const padding: styleFn;
declare const paddingTop: styleFn;
declare const paddingBottom: styleFn;
declare const paddingLeft: styleFn;
declare const paddingRight: styleFn;
...
declare interface TextColorProps {
    /**
...
declare const textColor: styleFn;

declare interface BackgroundColorProps<TLength = TLengthStyledSystem> {
    /**
     * The color utility parses a component's `color` and `bg` props and converts them into CSS declarations.
     * By default the raw value of the prop is returned.
     *
...
declare const backgroundColor: styleFn;

declare interface ColorProps extends TextColorProps, BackgroundColorProps, OpacityProps {}

declare const color: styleFn;

/**
 * Typography
 */

declare function getPx(n: any, scale: any): string;

declare interface FontSizeProps<TLength = TLengthStyledSystem> {
    /**
...
declare const fontSize: styleFn;

declare interface FontFamilyProps {
    fontFamily?: ResponsiveValue<CSS.FontFamilyProperty>;
}
declare const fontFamily: styleFn;

declare interface FontWeightProps {
    /**
...
declare const fontWeight: styleFn;

declare interface LineHeightProps<TLength = TLengthStyledSystem> {
    /**
...
declare const lineHeight: styleFn;

declare interface TextAlignProps {
    /**
...
declare const textAlign: styleFn;
...
declare const fontStyle: styleFn;

declare interface LetterSpacingProps<TLength = TLengthStyledSystem> {
    /**
...
declare const letterSpacing: styleFn;
...
declare const typography: styleFn;
...
declare const display: styleFn;

declare interface WidthProps<TLength = TLengthStyledSystem> {
    /**
...
declare const width: styleFn;

declare interface MaxWidthProps<TLength = TLengthStyledSystem> {
    /**
...
declare const maxWidth: styleFn;

declare interface MinWidthProps<TLength = TLengthStyledSystem> {
    /**
...
declare const minWidth: styleFn;

declare interface HeightProps<TLength = TLengthStyledSystem> {
    /**
...
declare const height: styleFn;

declare interface MaxHeightProps<TLength = TLengthStyledSystem> {
    /**
...
declare const maxHeight: styleFn;

declare interface MinHeightProps<TLength = TLengthStyledSystem> {
    /**
...
declare const minHeight: styleFn;

declare interface SizeProps<TLength = TLengthStyledSystem> {
    size?: ResponsiveValue<CSS.HeightProperty<TLength>>;
}

declare const size: styleFn;

declare interface VerticalAlignProps<TLength = TLengthStyledSystem> {
    /**
...
declare const verticalAlign: styleFn;

/**
 * Flexbox
 */
declare interface AlignItemsProps {
    /**
...
declare const alignItems: styleFn;

declare interface AlignContentProps {
    /**
...
declare const alignContent: styleFn;

declare interface JustifyItemsProps {
    /**
...
declare const justifyItems: styleFn;

declare interface JustifyContentProps {
    /**
...
declare const justifyContent: styleFn;

declare interface FlexWrapProps {
    /**
...
declare const flexWrap: styleFn;

declare interface FlexBasisProps<TLength = TLengthStyledSystem> {
...
declare const flexBasis: styleFn;

declare interface FlexDirectionProps {
    /**
...
declare const flexDirection: styleFn;

declare interface FlexProps<TLength = TLengthStyledSystem> {
    /**
...
declare const flex: styleFn;

declare interface JustifySelfProps {
    /**
...
declare const justifySelf: styleFn;

declare interface AlignSelfProps {
    /**
...
declare const alignSelf: styleFn;
...
declare const flexbox: styleFn;

/**
 * Grid Layout
 */

declare interface GridGapProps<TLength = TLengthStyledSystem> {
    /**
...
declare const gridGap: styleFn;

declare interface GridColumnGapProps<TLength = TLengthStyledSystem> {
    /**
...
declare const gridColumnGap: styleFn;

declare interface GridRowGapProps<TLength = TLengthStyledSystem> {
    /**
...
declare const gridRowGap: styleFn;

declare interface GridColumnProps {
    /**
...
declare const gridColumn: styleFn;

declare interface GridRowProps {
    /**
...
declare const gridRow: styleFn;

declare interface GridAutoFlowProps {
    /**
...
declare const gridAutoFlow: styleFn;

declare interface GridAutoColumnsProps<TLength = TLengthStyledSystem> {
    /**
...
declare const gridAutoColumns: styleFn;

declare interface GridAutoRowsProps<TLength = TLengthStyledSystem> {
    /**
...
declare const gridAutoRows: styleFn;

declare interface GridTemplateColumnsProps<TLength = TLengthStyledSystem> {
    /**
...
declare const gridTemplateColumns: styleFn;

declare interface GridTemplateRowsProps<TLength = TLengthStyledSystem> {
    /**
...
declare const gridTemplateRows: styleFn;

declare interface GridTemplateAreasProps {
    /**
...
declare const gridTemplateAreas: styleFn;

declare interface GridAreaProps {
    /**
...
declare const gridArea: styleFn;
...
declare const layout: styleFn;

/**
 * Borders
 */

declare interface BorderWidthProps<TLength = TLengthStyledSystem> {
    /**
...
declare const borderWidth: styleFn;

declare interface BorderStyleProps {
    /**
...
declare const borderStyle: styleFn;

declare interface BorderColorProps {
    /**
...
declare const borderColor: styleFn;

declare interface BorderTopProps<TLength = TLengthStyledSystem> {
    /**
...
declare const borderTop: styleFn;

declare interface BorderRightProps<TLength = TLengthStyledSystem> {
    /**
...
declare const borderRight: styleFn;

declare interface BorderBottomProps<TLength = TLengthStyledSystem> {
    /**
...
declare const borderBottom: styleFn;

declare interface BorderLeftProps<TLength = TLengthStyledSystem> {
    /**
...
declare const borderLeft: styleFn;

declare interface BorderRadiusProps<TLength = TLengthStyledSystem> {
    /**
...
declare const borderRadius: styleFn;

declare interface BordersProps
    extends BorderProps,
        BorderTopProps,
        BorderRightProps,
        BorderBottomProps,
...
declare const borders: styleFn;

declare interface BorderProps<TLength = TLengthStyledSystem>
...
declare const border: styleFn;

declare interface BoxShadowProps {
    /**
...
declare const boxShadow: styleFn;

declare interface TextShadowProps {
    /**
...
declare const textShadow: styleFn;

declare interface ShadowProps extends BoxShadowProps, TextShadowProps {}

declare const shadow: styleFn;

declare interface OpacityProps {
    /**
...
declare const opacity: styleFn;

declare interface OverflowProps {
    /**
...
declare const overflow: styleFn;
/**
 * Background
 */
...
declare const backgroundImage: styleFn;

declare interface BackgroundSizeProps<TLength = TLengthStyledSystem> {
    /**
...
declare const backgroundSize: styleFn;

declare interface BackgroundPositionProps<TLength = TLengthStyledSystem> {
    /**
...
declare const backgroundPosition: styleFn;

declare interface BackgroundRepeatProps {
    /**
...
declare const backgroundRepeat: styleFn;

declare interface BackgroundProps<TLength = TLengthStyledSystem>
...
declare const background: styleFn;

/**
 * Position
 */

declare interface ZIndexProps {
    /**
...
declare const zIndex: styleFn;

declare interface TopProps<TLength = TLengthStyledSystem> {
    /**
...
declare const top: styleFn;

declare interface RightProps<TLength = TLengthStyledSystem> {
    /**
...
declare const right: styleFn;

declare interface BottomProps<TLength = TLengthStyledSystem> {
    /**
...
declare const bottom: styleFn;

declare interface LeftProps<TLength = TLengthStyledSystem> {
    /**
...
declare const left: styleFn;

declare interface PositionProps extends ZIndexProps, TopProps, RightProps, BottomProps, LeftProps {
    /**
...
declare const position: styleFn;

declare interface ButtonStyleProps {
    variant?: ResponsiveValue<string>;
}

declare const buttonStyle: styleFn;

declare interface TextStyleProps {
    textStyle?: ResponsiveValue<string>;
}

declare const textStyle: styleFn;

declare interface ColorStyleProps {
    colors?: ResponsiveValue<string>;
}

declare const colorStyle: styleFn;
...
declare const styles: StylesProps;
